...
@section('title', 'Destinasi Wisata - Desa Karangcengis')
...
@section('content')
    ...
    <section class="pt-32 pb-20 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="text-center mb-12" data-aos="fade-up">
                <span class="inline-flex items-center justify-center text-emerald-600 font-extrabold text-xs tracking-widest uppercase mb-3 gap-2">
                    <span class="w-8 h-0.5 bg-emerald-600 rounded-full"></span>
                    Eksplorasi Desa
                    <span class="w-8 h-0.5 bg-emerald-600 rounded-full"></span>
                </span>
                <h1 class="text-4xl md:text-5xl lg:text-6xl font-extrabold text-slate-900 tracking-tight mb-4">Destinasi Kami</h1>
                <p class="text-slate-500 text-base mt-3 max-w-2xl mx-auto leading-relaxed">
                    Pilih dan geser kartu wisata di bawah ini untuk melihat detail lengkap tentang fasilitas, video, ulasan pengunjung, serta rute lokasinya.
                </p>
            </div>
            ...
            <div class="relative overflow-hidden py-4">
                ...
                <!-- BINGKAI DIAM DI TENGAH -->
                <div class="absolute pointer-events-none top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 w-full sm:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1.33rem)] h-[450px] rounded-[2rem] border-[4px] border-emerald-500 shadow-[0_0_30px_rgba(16,185,129,0.5)] z-20 transition-all duration-300"></div>

                <!-- Track Slider -->
                <div id="wisata-container" class="flex flex-nowrap gap-8 relative transition-transform duration-700 ease-[cubic-bezier(0.25,1,0.5,1)]">
                    
                    <!-- KARTU WISATA 1 -->
                    <div class="wisata-card flex-none w-full sm:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1.33rem)] group relative h-[450px] rounded-[2rem] overflow-hidden cursor-pointer shadow-lg transition-all duration-700 ease-out border border-white/50" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div class="absolute top-5 left-5 bg-white/90 backdrop-blur-md text-emerald-700 text-[10px] font-bold uppercase tracking-wider px-4 py-2 rounded-full shadow-md">Agrowisata</div>
                        <div class="absolute bottom-0 left-0 w-full p-6 flex flex-col justify-end">
                            <h3 class="text-2xl font-bold text-white mb-2 line-clamp-1">Botania Garden</h3>
                        </div>
                    </div>

                    <!-- KARTU WISATA 2 -->
                    <div class="wisata-card flex-none w-full sm:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1.33rem)] group relative h-[450px] rounded-[2rem] overflow-hidden cursor-pointer shadow-lg transition-all duration-700 ease-out border border-white/50" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div class="absolute inset-0 bg-gradient-to-t from-slate-900 via-slate-900/40 to-transparent opacity-80 group-hover:opacity-90 transition-opacity duration-300"></div>
                        <div class="absolute top-5 left-5 bg-white/90 backdrop-blur-md text-emerald-700 text-[10px] font-bold uppercase tracking-wider px-4 py-2 rounded-full shadow-md">Alam & Relaksasi</div>
                        <div class="absolute bottom-0 left-0 w-full p-6 flex flex-col justify-end">
                    ...
                    <!-- KARTU WISATA 3 -->
                    <div class="wisata-card flex-none w-full sm:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1.33rem)] group relative h-[450px] rounded-[2rem] overflow-hidden cursor-pointer shadow-lg transition-all duration-700 ease-out border border-white/50" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <div class="absolute inset-0 bg-gradient-to-t from-slate-900 via-slate-900/40 to-transparent opacity-80 group-hover:opacity-90 transition-opacity duration-300"></div>
                        <div class="absolute top-5 left-5 bg-white/90 backdrop-blur-md text-emerald-700 text-[10px] font-bold uppercase tracking-wider px-4 py-2 rounded-full shadow-md">Edukasi & Belanja</div>
                        <div class="absolute bottom-0 left-0 w-full p-6 flex flex-col justify-end">
    ...
    <section class="pb-24 relative z-10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div id="dynamic-content" class="content-visible bg-white/70 backdrop-blur-xl border border-slate-200/80 rounded-3xl p-6 sm:p-10 shadow-xl shadow-slate-200/50">
        ...
        const wisataData = [
            {
                ...
                spots: [
                    { 
                        ...
                        desc: "Rasakan sensasi memetik jambu kristal, jeruk, dan stroberi langsung dari pohonnya. Sangat seru karena pengunjung bisa mencicipi buah segar berkualitas tinggi sembari diajarkan cara memetik yang benar oleh petani lokal."
                    },
                    { 
                        name: "Green House Edukasi", 
                        image: "https://images.unsplash.com/photo-1464226184884-fa280b87c399?q=80&w=500",
                        desc: "Area ini dirancang khusus bagi Anda yang ingin belajar tentang pertanian modern. Terdapat instalasi hidroponik lengkap di mana pengunjung bisa belajar cara menyemai bibit hingga panen sayuran tanpa tanah."
                    },
                    { 
                        name: "Saung Kuliner Tradisional", 
                        image: "https://images.unsplash.com/photo-1511693892705-24e0303c621f?q=80&w=500",
                        desc: "Setelah lelah berkeliling, bersantailah di saung bambu yang sejuk ini. Anda bisa memesan mendoan hangat, es kelapa muda, dan hidangan khas pedesaan lainnya dengan pemandangan kebun yang asri."
                    }
                ],
                reviews: [
                    ...
                    { name: "Siti Rahmawati", avatar: "https://ui-avatars.com/api/?name=Siti+Rahmawati&background=0284c7&color=fff", rating: 5, date: "1 bulan lalu", comment: "Fasilitas lengkap, saung kulinernya nyaman dan harganya ramah di kantong. Rekomendasi wisata keluarga." }
                ]
            },
            {
                ...
                spots: [
                    { 
                        ...
                        desc: "Jalur semen mulus sepanjang hampir 2 kilometer yang aman untuk bersepeda maupun jogging pagi. Hamparan padi yang menguning di kanan-kiri menciptakan suasana pedesaan yang menenangkan hati."
                    },
                    { 
                        name: "Titik Foto Sunset", 
                        image: "https://images.unsplash.com/photo-1472214103451-9374bd1c798e?q=80&w=500",
                        desc: "Bagi pecinta fotografi, area ini wajib dikunjungi saat sore hari. Pemandangan matahari terbenam dengan siluet Gunung Slamet menciptakan refleksi emas di permukaan air sawah yang sangat memukau."
                    }
                ],
                reviews: [
            ...
            },
            {
                ...
                spots: [
                    { 
                        ...
                        desc: "Saksikan langsung kepiawaian ibu-ibu desa mengolah bilah bambu menjadi berbagai kerajinan estetik bernilai tinggi. Anda juga bisa ikut mencoba proses menganyam yang dibimbing langsung oleh ahlinya."
                    },
                    { 
                        name: "Etalase Bibit Buah", 
                        image: "https://images.unsplash.com/photo-1593489115206-8dce2828bce0?q=80&w=500",
                        desc: "Ingin berkebun di rumah? Sentra ini menyediakan berbagai bibit buah unggulan bersertifikat hasil cangkok dan okulasi petani Karangcengis yang dijamin subur dan cepat berbuah."
                    }
                ],
                reviews: [
                ...
                setTimeout(() => {
                    dynamicContentDiv.innerHTML = `
                        <div class="space-y-12">
                            ...
                            <!-- GRID UTAMA: Kiri (Deskripsi, Video, Info, Ulasan) & Kanan (Spot, Maps) -->
                            <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
                                ...
                                <div class="lg:col-span-7 space-y-8">
                                    ...
                                    <!-- Informasi Kunjungan (Tepat di Bawah Video) -->
                                    <div class="pt-6 border-t border-slate-200">
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            <!-- Info HTM -->
                                            <div class="bg-emerald-50/70 rounded-2xl p-4 border border-emerald-100">
                                            ...
                                            <!-- Info Jam -->
                                            <div class="bg-sky-50/70 rounded-2xl p-4 border border-sky-100">
                                            ...
                                            <!-- Kontak -->
                                            <div class="bg-amber-50/70 rounded-2xl p-4 border border-amber-100 sm:col-span-2">
                                    ...
                                    <!-- ULASAN PENGUNJUNG (Pindah ke sini, persis di bawah Informasi Kunjungan) -->
                                    <div class="pt-6 border-t border-slate-200">
